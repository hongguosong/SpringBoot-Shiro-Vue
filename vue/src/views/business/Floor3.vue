<template>
  <div class="dashboard-container">
    ...
    <div style="width:800px; margin: auto">
      <el-carousel :interval="3000" type="" height="200px">
        <el-carousel-item v-for="item in sourcePic" :key="item.id">
          <!--<img :src="item.pic"/>-->
          <div :style="{backgroundImage: item.pic}" style="background-repeat: no-repeat">{{ item.id }}</div>
        </el-carousel-item>
      </el-carousel>
    </div>
...
import qiangzhi from '@/images/qiangzhi.jpg'
import hua from '@/images/hua.jpg'
export default {
  name: 'dashboard',
  data () {
    return {
      sourcePic: [
        { id: 1, pic: 'url(' + mountain + ')' },
        { id: 2, pic: 'url(' + hua + ')' },
        { id: 3, pic: 'url(' + qiangzhi + ')' },
        { id: 4, pic: 'url(' + hua + ')' },
        { id: 5, pic: 'url(' + mountain + ')' },
        { id: 6, pic: 'url(' + qiangzhi + ')' }
      ],
