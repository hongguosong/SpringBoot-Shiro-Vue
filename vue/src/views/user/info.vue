<template>
  <div class="editor">
    <el-form ref="userEditorForm" :model="form" :rules="rules" label-width="100px" label-position="right">
      ...
      <el-form-item label="修改密码">
        <el-switch v-model="form.changePass"></el-switch>
      </el-form-item>
      <el-form-item label="初始密码:" prop="oldPassword" v-if="form.changePass">
        <el-input v-model="form.oldPassword" show-password></el-input>
      </el-form-item>
      <el-form-item label="新密码:" prop="newPassword" v-if="form.changePass">
        <el-input v-model="form.newPassword" show-password></el-input>
      </el-form-item>
      <el-form-item label="重复密码:" prop="passwordRepeat" v-if="form.changePass">
        <el-input v-model="form.passwordRepeat" show-password></el-input>
      </el-form-item>
      <el-form-item>
        <div style="float: right;">
          <el-button type="primary" @click="submitForm('userEditorForm')">submit</el-button>
          <el-button @click="resetForm('userEditorForm')">reset</el-button>
        </div>
      </el-form-item>
    </el-form>
  </div>
